...
tru_usb_cdc_linecoding_t cdcacm_rr_linecoding_1_0_0 = {
	.dte_rate = CDCACM_RR_DEFAULT_BIT_RATE,
	.char_format = CDCACM_RR_DEFAULT_CHAR_FORMAT,
	.parity_type = CDCACM_RR_DEFAULT_PARITY_TYPE,
	.data_bits = CDCACM_RR_DEFAULT_DATA_BITS
};

// Line control for each interface
tru_usb_cdc_linecontrol_t cdcacm_rr_linecontrol_1_0_0 = { .val = 0 };

// Encapsulated buffer for each interface
tru_usb_cdc_encap_t cdcacm_rr_encap_1_0_0 = {
	.encap_cmd = NULL,
...
tru_usb_cdc_uartstate_t cdcacm_rr_uartstate_1_0_0 = { .val = 0 };
...
const tru_usb_cdc_interface_ext_t cdcacm_rr_interface_exts[] = {
	{ .ext_hdr = { .config_num = 1, .interface_num = 0, .alt_setting_num = 0 }, .linecoding = &cdcacm_rr_linecoding_1_0_0, .linecontrol = &cdcacm_rr_linecontrol_1_0_0, .encap = &cdcacm_rr_encap_1_0_0, .uartstate = &cdcacm_rr_uartstate_1_0_0 },
	{ .ext_hdr = { .config_num = 1, .interface_num = 1, .alt_setting_num = 0 }, .linecoding = &cdcacm_rr_linecoding_1_0_0, .linecontrol = &cdcacm_rr_linecontrol_1_0_0, .encap = &cdcacm_rr_encap_1_0_0, .uartstate = &cdcacm_rr_uartstate_1_0_0 },
};
...
*/
const cdcacm_rr_ls_config1_desc_t cdcacm_rr_ls_config1_desc = {
	// Configuration descriptor
	.config_0 = {
		.length = sizeof(tru_usb_config_desc_t),
		.desc_type = TRU_USB_DESC_TYPE_CONFIG,
		.total_length = sizeof(cdcacm_rr_ls_config1_desc_t),
	...
	.interface_0_0_0 = {
		...
		.interface_num = CDCACM_RR_NTF_ITFNUM,
		.alt_setting_num = 0,
		.num_endpoints = 1,
	...
	.func_union_0_0_0 = {
		...
		.ctrl_interface_num = CDCACM_RR_NTF_ITFNUM,  // Interface number of the control
		.sub_interface_num = CDCACM_RR_DAT_ITFNUM  // Interface number of the subordinate
	},
	...
	.func_call_man_0_0_0 = {
		...
		.interface_num = CDCACM_RR_DAT_ITFNUM  // Interface number of the data
	},
	...
	.ep_comm_msg_0_0_0 = {
		...
		.address = {
			.bits.ep_num = CDCACM_RR_NTF_EPNUM,
			.bits.res4_6 = 0,
	...
	.interface_0_1_0 = {
		.length = sizeof(tru_usb_interface_desc_t),
		.desc_type = TRU_USB_DESC_TYPE_INTERFACE,
		.interface_num = CDCACM_RR_DAT_ITFNUM,
		.alt_setting_num = 0,
		.num_endpoints = 2,
	...
	.ep_data_in_0_1_0 = {
		...
		.desc_type = TRU_USB_DESC_TYPE_ENDPOINT,
		.address = {
			.bits.ep_num = CDCACM_RR_TXD_EPNUM,
			.bits.res4_6 = 0,
			.bits.dir = TRU_USB_EP_DIR_IN
		},
		.attributes = {
	...
	.ep_data_out_0_1_0 = {
		...
		.desc_type = TRU_USB_DESC_TYPE_ENDPOINT,
		.address = {
			.bits.ep_num = CDCACM_RR_RXD_EPNUM,
			.bits.res4_6 = 0,
...
const tru_usb_config_desc_set_t cdcacm_rr_ls_config_descs[] = {
	{ .desc = (uint8_t *)&cdcacm_rr_ls_config1_desc, .size = sizeof(cdcacm_rr_ls_config1_desc) }
};

// Total number of configurations for low speed mode
#define CDCACM_RR_LS_NUM_OF_CONFIGS (sizeof(cdcacm_rr_ls_config_descs) / sizeof(tru_usb_config_desc_set_t))
...
/*
	...
	Note:
		...
		instead they should be stored as a separate set using a class specific extension.
*/
const cdcacm_rr_fs_config1_desc_t cdcacm_rr_fs_config1_desc = {
	// Configuration descriptor
	.config_0 = {
		.length = sizeof(tru_usb_config_desc_t),
		.desc_type = TRU_USB_DESC_TYPE_CONFIG,
		.total_length = sizeof(cdcacm_rr_fs_config1_desc_t),
		.num_interfaces = 2,  // Number of interfaces (counting only alternate setting == 0) in this configuration
		.config_num = 1,
		.string_index = 0,  // Index of configuration string (0 = no string)
		.attributes =
	...
	.interface_0_1_0 = {
		...
		.interface_subclass = TRU_USB_CDC_DATA_INTERFACE_SUBCLASS_UNDEFINED,
		.interface_protocol = TRU_USB_CDC_DATA_INTERFACE_CLASS_PROTOCOL_UNDEFINED,
		.string_index = 0  // Index of interface string
	},
...
const tru_usb_config_desc_set_t cdcacm_rr_fs_config_descs[] = {
	{ .desc = (uint8_t *)&cdcacm_rr_fs_config1_desc, .size = sizeof(cdcacm_rr_fs_config1_desc) }
};

// Total number of configurations for full speed mode
#define CDCACM_RR_FS_NUM_OF_CONFIGS (sizeof(cdcacm_rr_fs_config_descs) / sizeof(tru_usb_config_desc_set_t))
...
const tru_usb_dev_desc_t cdcacm_rr_fs_dev_desc = {
	.length = sizeof(tru_usb_dev_desc_t),
	.desc_type = TRU_USB_DESC_TYPE_DEVICE,
	.usb_ver = CDCACM_RR_USB_VER,  // USB specification version number (BCD format)
	.dev_class = TRU_USB_DEVICE_CLASS_CDC,
	...
	.product = 2,  // Index of product string
	.serial = 3,  // Index of serial string
	.num_configs = CDCACM_RR_FS_NUM_OF_CONFIGS
};

#if CDCACM_RR_HS_DESC_ENABLE == 1
	...
	It contains descriptors for a single configuration, i.e. the following:
		1 configuration descriptor,
			1 or more interface descriptor(s),
				...
				0 or more endpoint descriptor(s) per interface
*/
const cdcacm_rr_hs_config1_desc_t cdcacm_rr_hs_config1_desc = {
	// Configuration descriptor
	.config_0 = {
		.length = sizeof(tru_usb_config_desc_t),
		.desc_type = TRU_USB_DESC_TYPE_CONFIG,
		.total_length = sizeof(cdcacm_rr_hs_config1_desc_t),
		.num_interfaces = 2,  // Number of interfaces (counting only alternate setting == 0) in this configuration
		.config_num = 1,
		.string_index = 0,  // Index of configuration string (0 = no string)
		.attributes =
...
const tru_usb_config_desc_set_t cdcacm_rr_hs_config_descs[] = {
	{ .desc = (uint8_t *)&cdcacm_rr_hs_config1_desc, .size = sizeof(cdcacm_rr_hs_config1_desc) }
};

// Total number of configurations for high speed mode
#define CDCACM_RR_HS_NUM_OF_CONFIGS (sizeof(cdcacm_rr_hs_config_descs) / sizeof(tru_usb_config_desc_set_t))
...
const tru_usb_dev_desc_t cdcacm_rr_hs_dev_desc = {
	.length = sizeof(tru_usb_dev_desc_t),
	.desc_type = TRU_USB_DESC_TYPE_DEVICE,
	.usb_ver = CDCACM_RR_USB_VER,  // USB specification version number (BCD format)
	.dev_class = TRU_USB_DEVICE_CLASS_CDC,
...
const tru_usb_dev_qual_desc_t cdcacm_rr_hs_dev_qual_desc = {
	.length = sizeof(tru_usb_dev_qual_desc_t),
	.desc_type = TRU_USB_DESC_TYPE_DEVICE_QUAL,
	.usb_ver = CDCACM_RR_USB_VER,  // USB release number
	.dev_class = TRU_USB_DEVICE_CLASS_CDC,
...
typedef struct __attribute__((packed)){
	...
	uint8_t desc_type;
	uint16_t lang_id[1];
}cdcacm_rr_string_lang_ids_t;

// Supported language IDs string descriptor
const cdcacm_rr_string_lang_ids_t cdcacm_rr_lang_string_desc = {
	.length = sizeof(cdcacm_rr_lang_string_desc),
...
typedef struct __attribute__((packed)){
	...
	uint8_t desc_type;
	uint16_t string[3];
}cdcacm_rr_string_manuf_t;

// Manufacturer string descriptor
const cdcacm_rr_string_manuf_t cdcacm_rr_manuf_string_desc = {
	.length = sizeof(cdcacm_rr_manuf_string_desc),
	.desc_type = TRU_USB_DESC_TYPE_STRING,
	.string = { 'T', 'r', 'u', }
};
...
typedef struct __attribute__((packed)){
	...
	uint8_t desc_type;
	uint16_t string[12];
}cdcacm_rr_string_product_t;

// Product string descriptor
const cdcacm_rr_string_product_t cdcacm_rr_prod_string_desc = {
	.length = sizeof(cdcacm_rr_prod_string_desc),
	.desc_type = TRU_USB_DESC_TYPE_STRING,
...
typedef struct __attribute__((packed)){
	...
	uint8_t desc_type;
	uint16_t string[3];
}cdcacm_rr_string_serial_t;

// Serial number string descriptor
const cdcacm_rr_string_serial_t cdcacm_rr_ser_string_desc = {
	.length = sizeof(cdcacm_rr_ser_string_desc),
	.desc_type = TRU_USB_DESC_TYPE_STRING,
	.string = { '1', '2', '3' }
};
...
const tru_usb_string_desc_info_t cdcacm_rr_string_descs[] = {
	{ .index = 0, .lang_id = TRU_USB_LANG_ID_NONE,       .desc = (void *)&cdcacm_rr_lang_string_desc },
	{ .index = 1, .lang_id = TRU_USB_LANG_ID_ENGLISH_US, .desc = (void *)&cdcacm_rr_manuf_string_desc },
	{ .index = 2, .lang_id = TRU_USB_LANG_ID_ENGLISH_US, .desc = (void *)&cdcacm_rr_prod_string_desc },
	{ .index = 3, .lang_id = TRU_USB_LANG_ID_ENGLISH_US, .desc = (void *)&cdcacm_rr_ser_string_desc }
};
...
// Common
tru_usb_pd_info_t cdcacm_rr_base_pd_info = {
#if CDCACM_RR_HS_DESC_ENABLE == 1
	.hs_dev_desc = (tru_usb_dev_desc_t *)&cdcacm_rr_hs_dev_desc,
#else
	.hs_dev_desc = NULL,
#endif
	.fs_dev_desc = (tru_usb_dev_desc_t *)&cdcacm_rr_fs_dev_desc,
	.ls_dev_desc = (tru_usb_dev_desc_t *)&cdcacm_rr_ls_dev_desc,

#if CDCACM_RR_HS_DESC_ENABLE == 1
	.hs_dev_qual_desc = (tru_usb_dev_qual_desc_t *)&cdcacm_rr_hs_dev_qual_desc,
	.fs_dev_qual_desc = (tru_usb_dev_qual_desc_t *)&cdcacm_rr_fs_dev_qual_desc,
#else
...
#if CDCACM_RR_HS_DESC_ENABLE == 1
	.hs_config_descs = (tru_usb_config_desc_set_t *)cdcacm_rr_hs_config_descs, .hs_config_descs_num_entries = sizeof(cdcacm_rr_hs_config_descs) / sizeof(tru_usb_config_desc_set_t),
#else
	.hs_config_descs = NULL, .hs_config_descs_num_entries = 0,
#endif
	.fs_config_descs = (tru_usb_config_desc_set_t *)cdcacm_rr_fs_config_descs, .fs_config_descs_num_entries = sizeof(cdcacm_rr_fs_config_descs) / sizeof(tru_usb_config_desc_set_t),
	.ls_config_descs = (tru_usb_config_desc_set_t *)cdcacm_rr_ls_config_descs, .ls_config_descs_num_entries = sizeof(cdcacm_rr_ls_config_descs) / sizeof(tru_usb_config_desc_set_t),

	.string_descs = (tru_usb_string_desc_info_t *)cdcacm_rr_string_descs, .string_descs_num_entries = sizeof(cdcacm_rr_string_descs) / sizeof(tru_usb_string_desc_info_t)
};

// Common + class
tru_usb_cdc_pd_info_t cdcacm_rr_cdc_pd_info = {
	.pd = &cdcacm_rr_base_pd_info,

#if CDCACM_RR_HS_DESC_ENABLE == 1
	.hs_cdc_interface_exts = (tru_usb_cdc_interface_ext_t *)cdcacm_rr_interface_exts, .hs_cdc_interface_exts_num_entries = sizeof(cdcacm_rr_interface_exts) / sizeof(tru_usb_cdc_interface_ext_t),
#else
	.hs_cdc_interface_exts = NULL, .hs_cdc_interface_exts_num_entries = 0,
#endif
	.fs_cdc_interface_exts = (tru_usb_cdc_interface_ext_t *)cdcacm_rr_interface_exts, .fs_cdc_interface_exts_num_entries = sizeof(cdcacm_rr_interface_exts) / sizeof(tru_usb_cdc_interface_ext_t),
	.ls_cdc_interface_exts = (tru_usb_cdc_interface_ext_t *)cdcacm_rr_interface_exts, .ls_cdc_interface_exts_num_entries = sizeof(cdcacm_rr_interface_exts) / sizeof(tru_usb_cdc_interface_ext_t),
};

tru_usb_cdc_pd_info_t *get_cdcacm_rr_pd_info(void){
	return (tru_usb_cdc_pd_info_t *)&cdcacm_rr_cdc_pd_info;
}
