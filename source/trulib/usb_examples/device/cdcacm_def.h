...
#define CDCACM_HS_DESC_ENABLE 1
...
*/
#define CDCACM_WIN_QUIRK_DEV_NOZLP4K  1  // Don't send a ZLP on 4K multiple transfers (required for Windows, tolerated on Linux)
#define CDCACM_WIN_QUIRK_DEV_FORCEZLP 1  // Always send a ZLP (disabled if NOZLP4K is enabled).  Working on Linux but not Windows
#define CDCACM_WIN_QUIRK_HST_NOZLP    1  // Limit receive to one MPS packet only (required for Linux and Windows)

// VID PID for open-source use from https://pid.codes/pids/
#define CDCACM_VID 0x1209
#define CDCACM_PID 0x0002
#define CDCACM_VER 0x0001

#define CDCACM_USB_VER 0x0200
//#define CDCACM_USB_VER 0x0110

#define CDCACM_NTF_ITFNUM 0
#define CDCACM_NTF_EPNUM  1
#define CDCACM_DAT_ITFNUM 1
#define CDCACM_TXD_EPNUM  2
#define CDCACM_RXD_EPNUM  2

#define CDCACM_DEFAULT_BIT_RATE    128000
#define CDCACM_DEFAULT_CHAR_FORMAT TRU_USB_CDC_LINECODING_STOPBITS_ONE
#define CDCACM_DEFAULT_PARITY_TYPE TRU_USB_CDC_LINECODING_PARITY_NONE
#define CDCACM_DEFAULT_DATA_BITS   8
